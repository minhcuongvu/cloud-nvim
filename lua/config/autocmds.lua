...
-- Force redraw when a floating window closes to clear tmux rendering artifacts
-- Uses a delayed timer because tmux's rendering pipeline can race with immediate redraws
vim.api.nvim_create_autocmd("WinClosed", {
	desc = "Redraw after float closes",
	group = vim.api.nvim_create_augroup("float-redraw", { clear = true }),
	callback = function(event)
